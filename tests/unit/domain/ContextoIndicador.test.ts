...
function indicador(parcial: Partial<Indicador> = {}): Indicador {
  return {
    ...
    estado: 'Activo', responsable: 'resp-1', categoria: 'cat-1', equipo: null, unidadMedida: '%', esCalculado: false, formula: null, esPadre: false, indicadoresHijoIds: [], tipoAgregacionPadre: null, requiereValidacion: true,
