...
describe('ServicioUsuarios', () => {
  ...
  it('eliminar()/restaurar() aplican borrado lógico, bloqueado si un indicador referencia al usuario como responsable', async () => {
    ...
    await indicadores.guardar({
      ...
      equipo: null, unidadMedida: null, periodicidadPersonalizadaId: null, esCalculado: false, formula: null, esPadre: false, indicadoresHijoIds: [], tipoAgregacionPadre: null, usarResultadoPropioEnResumenes: true,
